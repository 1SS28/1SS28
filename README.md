...
[View project](https://github.com/1SS28/autonomous-listing-agent)

- Text a photo to a Telegram bot → it generates studio quality product shots using Magic Hour API, writes the listing, and publishes it live to eBay or Etsy
...
### Stitch Taskbar Buddy

[View Project](https://github.com/1SS28/stitch-TaskbarBuddy)

- Animated Stitch desktop sprite iterating above the taskbar and reacts to time of day
- Frame based animation system on HTML5 Canvas, with a click triggered menu (via Electron IPC) to swap between animations on demand
